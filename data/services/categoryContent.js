...
import { getServicesByCategory } from './config'
...
export const CATEGORY_SECTIONS = [
  { id: 'accounting-compliance', categoryKey: 'accounting', label: 'Accounting & Compliance', heading: 'Reliable Financial Management and Compliance Support', intro: 'We help businesses and individuals maintain accurate records, meet filing deadlines, and stay compliant with HMRC and Companies House. From day-to-day bookkeeping to year-end accounts and payroll, we provide structured support so you can focus on running your business.', backgroundLabel: 'ACCOUNTING', backgroundPosition: 'right-mid' },
  { id: 'tax-services', categoryKey: 'tax', label: 'Tax Services', heading: 'Expert Tax Advice and Return Preparation', intro: 'Our tax team supports individuals and companies with self assessment, corporation tax, capital gains, and tax planning. We aim to ensure accurate returns, timely submissions, and practical advice to help you meet obligations and make informed decisions.', backgroundLabel: 'TAX', backgroundPosition: 'left-mid' },
  { id: 'business-advisory', categoryKey: 'advisory', label: 'Business Advisory', heading: 'Strategic Support for Startups and Growing Businesses', intro: 'From company formation and startup support to cashflow forecasting, CFO-level advisory, and business growth planning, we provide the financial clarity and strategic input that growing businesses need to scale with confidence.', backgroundLabel: 'ADVISORY', backgroundPosition: 'right-mid' },
  { id: 'property-services', categoryKey: 'property', label: 'Property Services', heading: 'Accounting and Tax Support for Property Investors', intro: 'We support landlords, SPVs, and property investors with rental accounting, property tax returns, and specialist reporting for HMOs and furnished holiday lets. Our aim is clear records, compliant filing, and practical tax advice.', backgroundLabel: 'PROPERTY', backgroundPosition: 'left-mid' },
]
...
export function getCategorySectionsWithServices() {
  ...
  return CATEGORY_SECTIONS.map((section, index) => {
    ...
    return { ...section, services, variant: index % 2 === 1 ? 'alt' : 'default' }
  })
}
