...
import { BUSINESS_TYPE_CONFIG, PRICING_MATRIX, SINGLE_SERVICES, PRICING_MODES } from '@/data/pricingData';
      ...
      <div className="pt-3 border-t border-brand-grayBorder/80 space-y-3">
        ...
        <div className="flex flex-col gap-2">
          ...
          <button
            ...
            className="inline-flex items-center justify-center rounded-full border border-brand-accent bg-white text-xs sm:text-sm font-medium text-brand-accent px-5 py-2.5 hover:bg-brand-accent hover:text-white transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-brand-accent min-h-[44px] disabled:opacity-60 disabled:cursor-not-allowed"
