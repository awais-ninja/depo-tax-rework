          ...
          {OPTIONS.map((option) => (
            ...
            >
              ...
              <Link
                ...
                className="inline-flex items-center justify-center min-h-[44px] px-5 py-2.5 rounded-xl font-semibold text-white bg-brand-accent hover:bg-brand-accentDark transition-colors duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-accent focus-visible:ring-offset-2"
              >
                {option.ctaLabel}
              </Link>
            </div>
