...
const REVIEWS = [
  {
    quote:
      "It's been over 8 years since Depo Tax Accountants and Tax Consultants have been helping me in my tax matters. Great Service. Really advised to anyone who is looking for accountants. Brilliant!!!",
    name: "Emanuel Correia",
    initials: "EC",
    reviewUrl: "https://share.google/qOfv4rDKFMtrYB43N",
  },
  {
    quote:
      "I have worked with DepoTax for the past 3 years now, starting with one business which is based on lettings. The Team are fantastic to work with. Very polite, knowledgeable and thorough. They offer the best advice for my situations at hand. DepoTax are very responsive to my requirements and needs, excellent in regular reminders to submit documents with a devotion to completing in timely manners. This leaves me stress free. A virtual office address service which is charged at a very reasonable price is also an option. I am extremely happy with the quality of work received from DepoTax. I now have another business based on developments which I seek the same services I do for my first business.",
    name: "Key2Success Lets",
    initials: "K2",
    reviewUrl: "https://share.google/LDqLg0lYl29ZXXXOb",
  },
  {
    quote:
      "I have been with DepoTax (and predecessor) for 8 years, both for my self-assessments and with my Management Consulting business Intelad. They are knowledgeable, kind, professional, very thorough and diligent. Always very timely in reaching out for key deadlines, hyper reactive—e.g. for urgent queries, they will go the extra mile even in situations where I wasn't the most reactive myself. I highly recommend.",
    name: "Khaled Diaw",
    initials: "KD",
    reviewUrl: "https://share.google/3nvbHWWMTBfM2zcAT",
  },
  {
    quote:
      "Working with my accountant has been nothing short of exceptional. Their professionalism, reliability, and genuine friendliness reflect a rare balance of precision and human warmth. They bring clarity where others bring confusion, and deliver solutions with both speed and integrity. It's refreshing to work with someone who not only understands the technical intricacies of financial strategy, but also operates with a level of honour, calm authority, and grace that makes every interaction effortless. This is not just an accountant—this is a trusted partner in growth.",
    name: "M A Wahid",
    initials: "MW",
    reviewUrl: "https://share.google/D8GKGxFwAIFr1LGay",
  },
  {
    quote:
      "Professional and qualified accountants with experience! I would say a very helpful and quick response from the Team! Well recommend to everyone who needs help with their business and accounts!",
    name: "Arkadiusz Paliwoda",
    initials: "AP",
    reviewUrl: "https://share.google/dzS0A0iK8Ig7J711K",
  },
  {
    quote:
      "I have used DepoTax's services for just over a year and I'm happy to say I'm very impressed. They helped me to set up a limited company and continue to provide a thorough service. Always on hand for an in-person meeting when useful, with a very calm and knowledgeable demeanour.",
    name: "Joe Terry",
    initials: "JT",
    reviewUrl: "https://share.google/GJcbCdug8aaxMguFh",
  },
  {
    quote:
      "I've been using Depo Tax as my accountants for nearly 5 years now. I am pleased with their service and have had no issues filing my personal self assessment with them—they are quick, and even under pressure they're always answering to me. I recommend using them for the nice range of services they provide. Especially as sometimes I needed to ask questions, it's easy booking virtual or in-person consultations. This is what matters the most for me.",
    name: "Joe Terry",
    initials: "JT",
    reviewUrl: "https://share.google/GJcbCdug8aaxMguFh",
  },
  {
    quote:
      "DepoTax provide an excellent professional service, knowledgeable, and always responsive. DepoTax makes managing my food safety company over the last 4 years so simple and easy. Couldn't ask for a better accountancy and team. Would thoroughly recommend.",
    name: "Damiano Rizzo",
    initials: "DR",
    reviewUrl: "https://share.google/z3afC7w8o7R1LqIK3",
  },
  {
    quote:
      "DepoTax has broad expertise in all tax-related matters and in navigating both HMRC and Companies House. They provide a reliable and professional service. I know I made the right decision to engage DepoTax for my companies. I confidently rate them 5 STARS.",
    name: "John Ramdeen",
    initials: "JR",
    reviewUrl: "https://share.google/SFWjODVGUGprbhy6P",
  },
  {
    quote:
      "I have been with Depo Tax since 2022. They have been exceptional as an accountant firm. They are always ready to assist me with my queries. I highly recommend Depo Tax's services.",
    name: "Gabriel Jara Espinoza",
    initials: "GJ",
    reviewUrl: "https://share.google/K0R3o4z25QboLn23w",
  },
];
...
export default function Testimonials({
  ...
  const scroll = (dir) => {
    ...
    const cardWidth =
      scrollRef.current.querySelector("[data-review-card]")?.offsetWidth || 380;
    scrollRef.current.scrollBy({
      left: (cardWidth + 24) * dir,
      behavior: "smooth",
    });
  };
    ...
    >
      ...
      <SectionReveal>
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div
            className="hidden md:block absolute top-20 left-8 text-[#9a0000] opacity-[0.06] font-serif text-[8rem] leading-none pointer-events-none select-none"
            aria-hidden
          >
            "
          </div>
          ...
          <div className="text-center mb-10">
            ...
            {/* Verified chip */}
            <p className="reveal-item reveal-item-delay-3 mt-3 text-xs font-medium text-brand-text/80">
              ...
              {reviews.map((review, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      className="flex gap-0.5 text-amber-500 mb-3"
                      aria-hidden
                    >
                      {[1, 2, 3, 4, 5].map((i) => (
                    ...
                    <p
                      className={`text-brand-text/90 text-sm leading-relaxed flex-1 ${isExpanded ? "" : "line-clamp-4"}`}
                    >
                      {review.quote}
                    </p>
