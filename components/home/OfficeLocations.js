          ...
          <div className="text-sm text-brand-text/85 space-y-0.5">
            {office.phones.map((num) => (
              <Link
                key={num}
                href={telHref(num)}
                className="min-h-12 py-2 inline-flex items-center hover:text-[#9a0000] transition-colors"
                aria-label={`Call ${num}`}
              >
                {num}
              </Link>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-[1fr,minmax(260px,320px)] min-h-0">
                ...
                <div className="p-5 sm:p-6 lg:p-8 bg-brand-grayLight/40 flex flex-col justify-center border-t lg:border-t-0 lg:border-l-0 border-brand-grayBorder">
                  ...
                  <Link
                    ...
                    className="inline-flex items-center justify-center w-full sm:w-auto min-h-12 px-5 py-2.5 rounded-lg text-sm font-semibold text-white bg-brand-accent hover:bg-brand-accentDark transition-colors duration-200"
                  >
                    Book an appointment
                  </Link>
                </div>
                  ...
                  <div className="flex gap-3 justify-center sm:justify-start">
                    ...
                    <div className="text-sm text-brand-text/85 space-y-0.5">
                      {HEAD_OFFICE.phones.map((num) => (
                        <Link key={num} href={`tel:${num.replace(/\s/g, '')}`} className="min-h-12 py-2 inline-flex items-center hover:text-brand-accent transition-colors" aria-label={`Call ${num}`}>
                          {num}
                        </Link>
                      ))}
                    </div>
          ...
          <div className="reveal-item reveal-item-delay-6 text-center rounded-2xl border border-brand-grayBorder bg-white px-6 py-8 sm:p-10 shadow-[0_4px_20px_rgba(15,23,42,0.06)]">
            ...
            <div className="flex flex-wrap items-center justify-center gap-3">
              <Link
                href="https://www.picktime.com/aazizandco"
                className="inline-flex items-center justify-center min-h-12 px-6 py-3 rounded-xl font-semibold text-white bg-[#9a0000] hover:bg-[#7a0000] transition-colors duration-200"
                aria-label="Book Consultation (locations section)"
              >
                Book Consultation
              </Link>
              <Link
                href="/contact"
                className="inline-flex items-center justify-center min-h-12 px-6 py-3 rounded-xl font-semibold border-2 border-[#9a0000] text-[#9a0000] hover:bg-[#9a0000] hover:text-white transition-colors duration-200"
                aria-label="Contact Us (locations section)"
              >
                Contact Us
              </Link>
            </div>
